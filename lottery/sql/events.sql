INSERT INTO events 
    ...
    VALUES 
        ...
        (
            ...
            NULL,
            false,
            'It''s a scavenger hunt of things around MIT/Boston. You can work in teams to try to hit all of the destinations/tasks fastest. The top prize is the Senior Week Nintendo Switch with Mario Kart 😎 and the four runner ups get a cake 🍰!'
        ),
        (
